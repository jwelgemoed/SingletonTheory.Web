...
userApplicationModule.controller('DomainPermissionAdminCtrl', ['$rootScope', '$scope', 'AuthAdminDomainPermissionsResource', 'AuthAdminDomainPermissionResource',
	  'AuthAdminDomainPermissionFunctionalPermissionsResource', 'localize', 'AuthService',
	function ($rootScope, $scope, authAdminDomainPermissionsResource, authAdminDomainPermissionResource,
	 authAdminDomainPermissionFunctionalPermissionsResource, localize, authService) {
		...
		$scope.saveSubElements = function () {
			if ($scope.subElementResource != undefined) {
				$scope.subElementResource.$update({ Id: $scope.subElementResource.DomainPermissionId }, function (result) {
					$scope.madeSubListChanges = true;
