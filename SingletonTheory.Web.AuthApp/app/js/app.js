...
userApplicationModule.config(['$routeProvider', '$locationProvider', '$httpProvider', function ($routeProvider, $locationProvider, $httpProvider) {
	...
	$routeProvider.when('/auth/authadmin/domainpermissionadmin',
			{
				templateUrl: '/partials/authadmin/domainpermissionadmin.html',
				controller: 'DomainPermissionAdminCtrl',
				access: 'AuthorizationAdministration_Access'
			});
	$routeProvider.when('/auth/authadmin/functionalpermissionadmin',
			{
				templateUrl: '/partials/authadmin/functionalpermissionadmin.html',
